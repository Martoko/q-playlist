...
- (void)viewDidLoad {
    ...
    self.items = [[NSArray alloc] initWithObjects:@"Example song 1", @"Example song 2", @"Example song 3", @"Example song 4", @"Example song 5", nil];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"JoinedServerCell" forIndexPath:indexPath];
